...
def run(map_size, map_height, n_chunks=1, backend_name=None, channel=None, instance=None, use_sv=False, shots=1,
        engine='Q', name=''):
...
if __name__ == '__main__':
    ...
    """
    run(map_size=args.map_size, map_height=args.map_height, n_chunks=args.n_chunks, backend_name=args.backend_name,
